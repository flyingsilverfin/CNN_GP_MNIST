...
\begin{figure}[h!]
\begin{minipage}[c]{.2\hsize}
\centering
\subfloat[Hard Digit]{\includegraphics[width=1cm]{figures/mnist/both_incorrect_example_linear.pdf}}
\end{minipage} %
\begin{minipage}[c]{.8\hsize}
\centering
